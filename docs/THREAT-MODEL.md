...
| Anchor attached to wrong UI element | Versioned complete admission, immutable context, explicit unavailable/recovery state, and owner-only append-only replacement | Persistence and bridge contract implemented; DOM reattachment pending |
